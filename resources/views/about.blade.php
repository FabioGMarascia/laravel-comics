...
<body>
    <h1 class="text-center display-1 fw-bold text-warning mt-4">COMICS LIST</h1>
            ...
            <div class="row mx-0  justify-content-around">
                ...
                <div class="col-3 px-0 my-4 px-4">
                    <div class="card cardBox border-2">
                        ...
                        <div class="card-img-overlay cardInfoBox text-white fw-bold text-center p-2 bg-black overflow-auto lh-lg">
